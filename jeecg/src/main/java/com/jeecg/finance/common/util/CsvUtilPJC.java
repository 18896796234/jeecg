...
public class CsvUtilPJC {  
    ...
    public void CSVFileUtil(String filename) throws Exception {  
        fis = new FileInputStream(filename);   // 建立输入流
        isw = new InputStreamReader(fis, ENCODE);  
        br = new BufferedReader(isw);  
    }  
    
    public void CSVFileUtil(MultipartFile file) throws Exception { 
    	//fis = (FileInputStream) file.getInputStream(); // 建立输入流
    	isw = new InputStreamReader(file.getInputStream(), ENCODE);  
        //isw = new InputStreamReader(fis, ENCODE);  
        br = new BufferedReader(isw);  
    }  
