 ...
 */
@Entity
@Table(name = "f_diary", schema = "")
@SuppressWarnings("serial")
public class FDiaryEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="DIARY_TYPE",nullable=true,length=32)
	public java.lang.String getDiaryType(){
	...
	@Column(name ="DIARY_DATE",nullable=true,length=20)
