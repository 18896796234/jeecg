package com.ting.finance.entity;
 ...
 */
@Entity
@Table(name = "f_property", schema = "")
@SuppressWarnings("serial")
public class FPropertyEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="BALANCE",nullable=true,scale=8,length=32)
	...
	@Column(name ="ORG",nullable=true,length=200)
	...
	@Column(name ="MONTH",nullable=true,length=200)
