...
public class Constants {
	//邮件发送配置
		...
		public static final String MAIL_SENDER = "460216367@qq.com";
		public static final String SENDER_USER = "460216367@qq.com";
		public static final String SENDER_PASSWD = "QQ1499961274"; //密码
		//短信发送配置
