...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="fDiaryList" checkbox="false" pagination="true" fitColumns="true" title="日记" actionUrl="fDiaryController.do?datagrid" idField="id" sortName="createDate" fit="true" queryMode="group">
   ...
   <t:dgCol title="日记类型"  field="diaryType"  queryMode="single"  dictionary="diary_type"  width="120"></t:dgCol>
   <t:dgCol title="内容"  field="content" hidden="true" queryMode="single"  width="500"></t:dgCol>
