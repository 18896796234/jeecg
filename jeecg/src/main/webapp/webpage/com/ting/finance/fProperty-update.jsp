...
<t:base type="bootstrap,bootstrap-table,layer,validform,bootstrap-form"></t:base>
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="fPropertyController.do?doUpdate" method="POST">
		<input type="hidden" id="btn_sub" class="btn_sub"/>
		<input type="hidden" id="id" name="id" value="${fProperty.id}"/>
	<div class="form-group">
		<label for="balance" class="col-sm-3 control-label">余额：</label>
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="balance" name="balance" value='${fProperty.balance}' type="text" maxlength="32" class="form-control" placeholder="请输入余额"  ignore="ignore" />
			</div>
		</div>
	</div>
	...
	<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="month" name="month" type="text" maxlength="32" class="form-control input-sm" placeholder="月份" value="${fProperty.month }" ignore="ignore" />
				</div>
			</div>
		</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="content" name="content" value='${fProperty.content}' type="text" maxlength="200" class="form-control input-sm" placeholder="请输入描述"  ignore="ignore" />
			</div>
		</div>
	</div>
	</form>
